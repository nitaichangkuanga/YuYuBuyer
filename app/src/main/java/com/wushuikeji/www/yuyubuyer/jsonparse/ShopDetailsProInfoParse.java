 ...
 * @des 解析商品
 */
public class ShopDetailsProInfoParse {

    public static List<ShopDetailsBean> proInfoParse(String jsonString) {

        List<ShopDetailsBean> list = new ArrayList<ShopDetailsBean>();

        try {
            JSONObject obj = new JSONObject(jsonString);
            JSONArray shop_productArray = obj.getJSONArray("proInfo");
